...
const PLAN_SCHEMA = {
  ...
  properties: {
    intent: { type: "string", enum: ["system", "recent", "knowledge", "git", "github", "browser", "cleanup", "audit", "launch", "weather", "news", "cricket", "answer", "clarify"] },
