...
const PLAN_SCHEMA = {
  ...
  properties: {
    intent: { type: "string", enum: ["system", "recent", "knowledge", "git", "github", "browser", "cleanup", "audit", "launch", "answer", "clarify"] },
